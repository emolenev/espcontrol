...
EspControl's roadmap is tracked on the [GitHub issues page](https://github.com/emolenev/espcontrol/issues). That is the best place to see which features are being discussed, planned, or worked on.
...
If you have a new feature in mind, please [start a GitHub issue](https://github.com/emolenev/espcontrol/issues/new) and describe:
...
- Browse [open issues](https://github.com/emolenev/espcontrol/issues) to see current ideas and active work.
- Watch [GitHub Releases](https://github.com/emolenev/espcontrol/releases) to see what has shipped.
