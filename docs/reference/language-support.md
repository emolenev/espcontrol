...
The source list for that built-in screen text is the [English strings file](https://github.com/emolenev/espcontrol/blob/main/common/config/strings.en.txt). Each supported language has a matching file in the same folder.
...
If you find text on the screen that is translated incorrectly, please [raise a GitHub issue](https://github.com/emolenev/espcontrol/issues/new) and include:
...
If you are comfortable making the change yourself, you can also open a pull request. Use the [English strings file](https://github.com/emolenev/espcontrol/blob/main/common/config/strings.en.txt) as the reference and edit only the translated text after each `=`.

## Request a New Language

If you want EspControl to support another language, please [raise a GitHub issue](https://github.com/emolenev/espcontrol/issues/new). Ideally, include the translated content as part of the request, using the [English strings file](https://github.com/emolenev/espcontrol/blob/main/common/config/strings.en.txt) as the source.
