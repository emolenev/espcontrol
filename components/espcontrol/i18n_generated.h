...
inline const char *espcontrol_i18n_ru(const char *text) {
  ...
  if (std::strcmp(text, "Alarm") == 0) return "Тревога / Сигнализация";
  if (std::strcmp(text, "Alarm action failed") == 0) return "Не удалось выполнить действие сигнализации";
  if (std::strcmp(text, "Alarm did not change") == 0) return "Состояние сигнализации не изменилось";
  if (std::strcmp(text, "All done") == 0) return "Всё готово";
  if (std::strcmp(text, "Always On") == 0) return "Всегда включено";
  if (std::strcmp(text, "Arm Away") == 0) return "Поставить на охрану (вне дома)";
  if (std::strcmp(text, "Arm Home") == 0) return "Поставить на охрану (дома)";
  if (std::strcmp(text, "Arm Night") == 0) return "Поставить на охрану (ночной режим)";
  if (std::strcmp(text, "Arm Vacation") == 0) return "Поставить на охрану (отпуск)";
  if (std::strcmp(text, "Armed Away") == 0) return "На охране (вне дома)";
  if (std::strcmp(text, "Armed Custom") == 0) return "На охране (пользовательский режим)";
  if (std::strcmp(text, "Armed Home") == 0) return "На охране (дома)";
  if (std::strcmp(text, "Armed Night") == 0) return "На охране (ночной режим)";
  if (std::strcmp(text, "Armed Vacation") == 0) return "На охране (отпуск)";
  ...
  if (std::strcmp(text, "Clear Night") == 0) return "Ясная ночь";
  if (std::strcmp(text, "Climate") == 0) return "Климат";
  if (std::strcmp(text, "Clean Area") == 0) return "Зона уборки";
  ...
  if (std::strcmp(text, "Cloudy Alert") == 0) return "Предупреждение: облачно";
  if (std::strcmp(text, "Configure") == 0) return "Настроить";
  if (std::strcmp(text, "Cool") == 0) return "Охлаждение";
  if (std::strcmp(text, "Cooling") == 0) return "Охлаждение (процесс)";
  if (std::strcmp(text, "Could not complete") == 0) return "Не удалось завершить";
  if (std::strcmp(text, "Could not load") == 0) return "Не удалось загрузить";
  if (std::strcmp(text, "Cover") == 0) return "Штора / Покрытие (в зависимости от контекста)";
  if (std::strcmp(text, "Date") == 0) return "Дата";
  if (std::strcmp(text, "Dev") == 0) return "Разработка";
  if (std::strcmp(text, "Dev build") == 0) return "Сборка для разработчиков";
  if (std::strcmp(text, "Device Volume") == 0) return "Громкость устройства";
  if (std::strcmp(text, "Dimmed") == 0) return "Приглушённый (свет/экран)";
  ...
  if (std::strcmp(text, "Dock") == 0) return "Док-станция";
  if (std::strcmp(text, "Docked") == 0) return "На док-станции";
  if (std::strcmp(text, "Dry") == 0) return "Сушка";
  if (std::strcmp(text, "Drying") == 0) return "Сушка (процесс)";
  if (std::strcmp(text, "Dust") == 0) return "Пыль";
  if (std::strcmp(text, "Enter Pin") == 0) return "Введите PIN-код";
  if (std::strcmp(text, "Error") == 0) return "Ошибка";
  if (std::strcmp(text, "Exceptional") == 0) return "Исключительный / Чрезвычайный (часто для погоды)";
  ...
  if (std::strcmp(text, "Hazy") == 0) return "Мгла / Затуманено";
  if (std::strcmp(text, "Heat") == 0) return "Обогрев";
  if (std::strcmp(text, "Heat/Cool") == 0) return "Обогрев/охлаждение";
  if (std::strcmp(text, "Heating") == 0) return "Обогрев (процесс)";
  if (std::strcmp(text, "Heavy Snow") == 0) return "Сильный снег";
  if (std::strcmp(text, "High") == 0) return "Высокий";
  if (std::strcmp(text, "High target") == 0) return "Целевое значение: высокое";
  if (std::strcmp(text, "Holduntil") == 0) return "Удерживать до";
  if (std::strcmp(text, "Home") == 0) return "Дом";
  if (std::strcmp(text, "Hourly") == 0) return "Почасовой";
  if (std::strcmp(text, "Hurricane") == 0) return "Ураган";
  if (std::strcmp(text, "Idle") == 0) return "В режиме ожидания";
  if (std::strcmp(text, "Lightning") == 0) return "Молния";
  if (std::strcmp(text, "Lightning And Rain") == 0) return "Молния и дождь";
  if (std::strcmp(text, "Light") == 0) return "Свет";
  if (std::strcmp(text, "Loading") == 0) return "Загрузка";
  if (std::strcmp(text, "Locate") == 0) return "Найти / Определить местоположение";
  if (std::strcmp(text, "Lock") == 0) return "Заблокировать";
  if (std::strcmp(text, "Lawn Mower") == 0) return "Газонокосилка";
  if (std::strcmp(text, "Low") == 0) return "Низкий";
  if (std::strcmp(text, "Low target") == 0) return "Целевое значение: низкое";
  if (std::strcmp(text, "Media") == 0) return "Медиа";
  if (std::strcmp(text, "Medium") == 0) return "Средний";
  if (std::strcmp(text, "Mode") == 0) return "Режим";
  if (std::strcmp(text, "Monthly") == 0) return "Ежемесячный";
  if (std::strcmp(text, "more") == 0) return "Ещё";
  if (std::strcmp(text, "More items") == 0) return "Ещё элементы";
  if (std::strcmp(text, "Mowing") == 0) return "Кошение травы";
  ...
  if (std::strcmp(text, "None") == 0) return "Нет / Ничего";
  if (std::strcmp(text, "No options") == 0) return "Нет опций";
  if (std::strcmp(text, "No presets") == 0) return "Нет предустановок";
  if (std::strcmp(text, "Not available") == 0) return "Недоступно";
  if (std::strcmp(text, "Off") == 0) return "Выкл";
  if (std::strcmp(text, "On") == 0) return "Вкл";
  if (std::strcmp(text, "Open") == 0) return "Открыть";
  if (std::strcmp(text, "Opening") == 0) return "Открывается";
  if (std::strcmp(text, "Option") == 0) return "Опция";
  if (std::strcmp(text, "Oscillating") == 0) return "Качающийся (например, вентилятор)";
  if (std::strcmp(text, "Oscillation") == 0) return "Качание / Осцилляция";
  if (std::strcmp(text, "Partly Cloudy") == 0) return "Переменная облачность";
  if (std::strcmp(text, "Partly Cloudy Night") == 0) return "Переменная облачность ночью";
  if (std::strcmp(text, "Partly Lightning") == 0) return "Местами молнии";
  ...
  if (std::strcmp(text, "Paused") == 0) return "На паузе";
  if (std::strcmp(text, "Pending") == 0) return "В ожидании";
  if (std::strcmp(text, "Permanenthold") == 0) return "Постоянное удержание";
  if (std::strcmp(text, "PIN was not accepted") == 0) return "PIN-код не принят";
  if (std::strcmp(text, "Play/Pause") == 0) return "Воспроизвести/Пауза";
  ...
  if (std::strcmp(text, "Preset") == 0) return "Предустановка";
  if (std::strcmp(text, "Previous") == 0) return "Назад / Предыдущий";
  if (std::strcmp(text, "Push") == 0) return "Нажать";
  if (std::strcmp(text, "Quiet") == 0) return "Тихий режим";
  if (std::strcmp(text, "Rainy") == 0) return "Дождливо";
  if (std::strcmp(text, "Relay") == 0) return "Реле";
  if (std::strcmp(text, "Returning") == 0) return "Возвращается";
  if (std::strcmp(text, "Run this script?") == 0) return "Запустить этот скрипт?";
  ...
  if (std::strcmp(text, "Skip Next") == 0) return "Пропустить следующий";
  if (std::strcmp(text, "Skip Previous") == 0) return "Пропустить предыдущий";
  if (std::strcmp(text, "Snowy") == 0) return "Снежно";
  if (std::strcmp(text, "Snowy And Rain") == 0) return "Снег с дождём";
  if (std::strcmp(text, "Spot Clean") == 0) return "Точечная уборка";
  if (std::strcmp(text, "Start") == 0) return "Старт / Начать";
  if (std::strcmp(text, "Still") == 0) return "Неподвижно / Спокойно";
  if (std::strcmp(text, "Subpage") == 0) return "Подстраница";
  if (std::strcmp(text, "Sunny") == 0) return "Солнечно";
  if (std::strcmp(text, "Sunny Alert") == 0) return "Предупреждение: солнечно (или «Ясно»)";
  if (std::strcmp(text, "Sunset") == 0) return "Закат";
  if (std::strcmp(text, "Sunset Down") == 0) return "Закат (вниз)";
  if (std::strcmp(text, "Sunset Up") == 0) return "Закат (вверх) — тут лучше смотреть по интерфейсу, возможно, направление";
  if (std::strcmp(text, "Swing") == 0) return "Качание / Режим качания (жалюзи/вентилятор)";
  if (std::strcmp(text, "Target") == 0) return "Целевое значение";
  if (std::strcmp(text, "Temporaryhold") == 0) return "Временное удержание";
  if (std::strcmp(text, "Today") == 0) return "Сегодня";
  if (std::strcmp(text, "Todo") == 0) return "Задачи / Сделать";
  ...
  if (std::strcmp(text, "Track") == 0) return "Отслеживать / Трек";
  ...
  if (std::strcmp(text, "Vacationhold") == 0) return "Удержание на период отпуска";
  if (std::strcmp(text, "Vacuum") == 0) return "Пылесос / Уборка пылесосом";
  ...
  if (std::strcmp(text, "Weekly") == 0) return "Еженедельный";
  ...
  if (std::strcmp(text, "World Clock") == 0) return "Мировые часы";
  if (std::strcmp(text, "Yes") == 0) return "Да";
  if (std::strcmp(text, "Add this device in Home Assistant\nto enable control") == 0) return "Добавьте это устройство в Home Assistant, чтобы включить управление";
  if (std::strcmp(text, "Allow this device to perform\nHome Assistant actions") == 0) return "Разрешить этому устройству выполнять действия в Home Assistant";
  if (std::strcmp(text, "Booting") == 0) return "Загрузка";
  if (std::strcmp(text, "Connect an Ethernet cable\nand wait for a network address") == 0) return "Подключите Ethernet‑кабель и дождитесь получения сетевого адреса";
  if (std::strcmp(text, "Connect to the setup hotspot\nthen open 192.168.4.1") == 0) return "Подключитесь к точке доступа настройки, затем откройте 192.168.4.1";
  if (std::strcmp(text, "Connect to WiFi") == 0) return "Подключиться к Wi‑Fi";
  ...
  if (std::strcmp(text, "Connecting to WiFi") == 0) return "Подключение к Wi‑Fi";
  ...
  if (std::strcmp(text, "Install") == 0) return "Установить обновление прошивки";
  if (std::strcmp(text, "No saved WiFi connection\nReinstall by USB to reconfigure") == 0) return "Нет сохранённого подключения Wi‑Fi. Переустановите через USB для повторной настройки";
  if (std::strcmp(text, "Open 192.168.4.1") == 0) return "Откройте 192.168.4.1";
  if (std::strcmp(text, "Open your browser and\nconfigure your display") == 0) return "Откройте браузер и настройте дисплей";
  if (std::strcmp(text, "Preparing the screen\nDo not power off") == 0) return "Подготовка экрана. Не выключайте питание";
  if (std::strcmp(text, "Restarting display") == 0) return "Перезагрузка дисплея";
  if (std::strcmp(text, "See the install guide for help") == 0) return "См. руководство по установке для помощи";
  ...
  if (std::strcmp(text, "The screen may turn off\nDo not power off") == 0) return "Экран может выключиться. Не выключайте питание";
  if (std::strcmp(text, "Try installing the update again") == 0) return "Попробуйте установить обновление ещё раз";
  if (std::strcmp(text, "Trying to reconnect\nto your saved network") == 0) return "Попытка переподключения к сохранённой сети";
  ...
  if (std::strcmp(text, "WiFi Disconnected") == 0) return "Wi‑Fi отключён";
  if (std::strcmp(text, "WiFi Setup") == 0) return "Настройка Wi‑Fi";
  return text;
}
...
inline const char *espcontrol_i18n_key_ru(const char *key) {
  ...
  if (std::strcmp(key, "alarm") == 0) return "Тревога / Сигнализация";
  if (std::strcmp(key, "alarm_action_failed") == 0) return "Не удалось выполнить действие сигнализации";
  if (std::strcmp(key, "alarm_did_not_change") == 0) return "Состояние сигнализации не изменилось";
  if (std::strcmp(key, "all_done") == 0) return "Всё готово";
  if (std::strcmp(key, "always_on") == 0) return "Всегда включено";
  if (std::strcmp(key, "arm_away") == 0) return "Поставить на охрану (вне дома)";
  if (std::strcmp(key, "arm_home") == 0) return "Поставить на охрану (дома)";
  if (std::strcmp(key, "arm_night") == 0) return "Поставить на охрану (ночной режим)";
  if (std::strcmp(key, "arm_vacation") == 0) return "Поставить на охрану (отпуск)";
  if (std::strcmp(key, "armed_away") == 0) return "На охране (вне дома)";
  if (std::strcmp(key, "armed_custom") == 0) return "На охране (пользовательский режим)";
  if (std::strcmp(key, "armed_home") == 0) return "На охране (дома)";
  if (std::strcmp(key, "armed_night") == 0) return "На охране (ночной режим)";
  if (std::strcmp(key, "armed_vacation") == 0) return "На охране (отпуск)";
  ...
  if (std::strcmp(key, "clear_night") == 0) return "Ясная ночь";
  if (std::strcmp(key, "climate") == 0) return "Климат";
  if (std::strcmp(key, "clean_area") == 0) return "Зона уборки";
  ...
  if (std::strcmp(key, "cloudy_alert") == 0) return "Предупреждение: облачно";
  if (std::strcmp(key, "configure") == 0) return "Настроить";
  if (std::strcmp(key, "cool") == 0) return "Охлаждение";
  if (std::strcmp(key, "cooling") == 0) return "Охлаждение (процесс)";
  if (std::strcmp(key, "could_not_complete") == 0) return "Не удалось завершить";
  if (std::strcmp(key, "could_not_load") == 0) return "Не удалось загрузить";
  if (std::strcmp(key, "cover") == 0) return "Штора / Покрытие (в зависимости от контекста)";
  if (std::strcmp(key, "date") == 0) return "Дата";
  if (std::strcmp(key, "dev") == 0) return "Разработка";
  if (std::strcmp(key, "dev_build") == 0) return "Сборка для разработчиков";
  if (std::strcmp(key, "device_volume") == 0) return "Громкость устройства";
  if (std::strcmp(key, "dimmed") == 0) return "Приглушённый (свет/экран)";
  ...
  if (std::strcmp(key, "dock") == 0) return "Док-станция";
  if (std::strcmp(key, "docked") == 0) return "На док-станции";
  if (std::strcmp(key, "dry") == 0) return "Сушка";
  if (std::strcmp(key, "drying") == 0) return "Сушка (процесс)";
  if (std::strcmp(key, "dust") == 0) return "Пыль";
  if (std::strcmp(key, "enter_pin") == 0) return "Введите PIN-код";
  if (std::strcmp(key, "error") == 0) return "Ошибка";
  if (std::strcmp(key, "exceptional") == 0) return "Исключительный / Чрезвычайный (часто для погоды)";
  ...
  if (std::strcmp(key, "hazy") == 0) return "Мгла / Затуманено";
  if (std::strcmp(key, "heat") == 0) return "Обогрев";
  if (std::strcmp(key, "heat_cool") == 0) return "Обогрев/охлаждение";
  if (std::strcmp(key, "heating") == 0) return "Обогрев (процесс)";
  if (std::strcmp(key, "heavy_snow") == 0) return "Сильный снег";
  if (std::strcmp(key, "high") == 0) return "Высокий";
  if (std::strcmp(key, "high_target") == 0) return "Целевое значение: высокое";
  if (std::strcmp(key, "holduntil") == 0) return "Удерживать до";
  if (std::strcmp(key, "home") == 0) return "Дом";
  if (std::strcmp(key, "hourly") == 0) return "Почасовой";
  if (std::strcmp(key, "hurricane") == 0) return "Ураган";
  if (std::strcmp(key, "idle") == 0) return "В режиме ожидания";
  if (std::strcmp(key, "lightning") == 0) return "Молния";
  if (std::strcmp(key, "lightning_and_rain") == 0) return "Молния и дождь";
  if (std::strcmp(key, "light") == 0) return "Свет";
  if (std::strcmp(key, "loading") == 0) return "Загрузка";
  if (std::strcmp(key, "locate") == 0) return "Найти / Определить местоположение";
  if (std::strcmp(key, "lock") == 0) return "Заблокировать";
  if (std::strcmp(key, "lawn_mower") == 0) return "Газонокосилка";
  if (std::strcmp(key, "low") == 0) return "Низкий";
  if (std::strcmp(key, "low_target") == 0) return "Целевое значение: низкое";
  if (std::strcmp(key, "media") == 0) return "Медиа";
  if (std::strcmp(key, "medium") == 0) return "Средний";
  if (std::strcmp(key, "mode") == 0) return "Режим";
  if (std::strcmp(key, "monthly") == 0) return "Ежемесячный";
  if (std::strcmp(key, "more") == 0) return "Ещё";
  if (std::strcmp(key, "more_items") == 0) return "Ещё элементы";
  if (std::strcmp(key, "mowing") == 0) return "Кошение травы";
  ...
  if (std::strcmp(key, "none") == 0) return "Нет / Ничего";
  if (std::strcmp(key, "no_options") == 0) return "Нет опций";
  if (std::strcmp(key, "no_presets") == 0) return "Нет предустановок";
  if (std::strcmp(key, "not_available") == 0) return "Недоступно";
  if (std::strcmp(key, "off") == 0) return "Выкл";
  if (std::strcmp(key, "on") == 0) return "Вкл";
  ...
  if (std::strcmp(key, "option") == 0) return "Опция";
  if (std::strcmp(key, "oscillating") == 0) return "Качающийся (например, вентилятор)";
  if (std::strcmp(key, "oscillation") == 0) return "Качание / Осцилляция";
  if (std::strcmp(key, "partly_cloudy") == 0) return "Переменная облачность";
  if (std::strcmp(key, "partly_cloudy_night") == 0) return "Переменная облачность ночью";
  if (std::strcmp(key, "partly_lightning") == 0) return "Местами молнии";
  ...
  if (std::strcmp(key, "paused") == 0) return "На паузе";
  if (std::strcmp(key, "pending") == 0) return "В ожидании";
  if (std::strcmp(key, "permanenthold") == 0) return "Постоянное удержание";
  if (std::strcmp(key, "pin_was_not_accepted") == 0) return "PIN-код не принят";
  if (std::strcmp(key, "play_pause") == 0) return "Воспроизвести/Пауза";
  ...
  if (std::strcmp(key, "preset") == 0) return "Предустановка";
  if (std::strcmp(key, "previous") == 0) return "Назад / Предыдущий";
  if (std::strcmp(key, "push") == 0) return "Нажать";
  if (std::strcmp(key, "quiet") == 0) return "Тихий режим";
  if (std::strcmp(key, "rainy") == 0) return "Дождливо";
  if (std::strcmp(key, "relay") == 0) return "Реле";
  if (std::strcmp(key, "returning") == 0) return "Возвращается";
  if (std::strcmp(key, "run_this_script") == 0) return "Запустить этот скрипт?";
  ...
  if (std::strcmp(key, "skip_next") == 0) return "Пропустить следующий";
  if (std::strcmp(key, "skip_previous") == 0) return "Пропустить предыдущий";
  if (std::strcmp(key, "snowy") == 0) return "Снежно";
  if (std::strcmp(key, "snowy_and_rain") == 0) return "Снег с дождём";
  if (std::strcmp(key, "spot_clean") == 0) return "Точечная уборка";
  if (std::strcmp(key, "start") == 0) return "Старт / Начать";
  if (std::strcmp(key, "still") == 0) return "Неподвижно / Спокойно";
  if (std::strcmp(key, "subpage") == 0) return "Подстраница";
  if (std::strcmp(key, "sunny") == 0) return "Солнечно";
  if (std::strcmp(key, "sunny_alert") == 0) return "Предупреждение: солнечно (или «Ясно»)";
  if (std::strcmp(key, "sunset") == 0) return "Закат";
  if (std::strcmp(key, "sunset_down") == 0) return "Закат (вниз)";
  if (std::strcmp(key, "sunset_up") == 0) return "Закат (вверх) — тут лучше смотреть по интерфейсу, возможно, направление";
  if (std::strcmp(key, "swing") == 0) return "Качание / Режим качания (жалюзи/вентилятор)";
  if (std::strcmp(key, "target") == 0) return "Целевое значение";
  if (std::strcmp(key, "temporaryhold") == 0) return "Временное удержание";
  if (std::strcmp(key, "today") == 0) return "Сегодня";
  if (std::strcmp(key, "todo") == 0) return "Задачи / Сделать";
  ...
  if (std::strcmp(key, "track") == 0) return "Отслеживать / Трек";
  ...
  if (std::strcmp(key, "vacationhold") == 0) return "Удержание на период отпуска";
  if (std::strcmp(key, "vacuum") == 0) return "Пылесос / Уборка пылесосом";
  ...
  if (std::strcmp(key, "weekly") == 0) return "Еженедельный";
  ...
  if (std::strcmp(key, "world_clock") == 0) return "Мировые часы";
  if (std::strcmp(key, "yes") == 0) return "Да";
  if (std::strcmp(key, "add_this_device_in_home_assistant_to_enable_control") == 0) return "Добавьте это устройство в Home Assistant, чтобы включить управление";
  if (std::strcmp(key, "allow_this_device_to_perform_home_assistant_actions") == 0) return "Разрешить этому устройству выполнять действия в Home Assistant";
  if (std::strcmp(key, "booting") == 0) return "Загрузка";
  if (std::strcmp(key, "connect_an_ethernet_cable_and_wait_for_a_network_address") == 0) return "Подключите Ethernet‑кабель и дождитесь получения сетевого адреса";
  if (std::strcmp(key, "connect_to_the_setup_hotspot_then_open_192_168_4_1") == 0) return "Подключитесь к точке доступа настройки, затем откройте 192.168.4.1";
  if (std::strcmp(key, "connect_to_wifi") == 0) return "Подключиться к Wi‑Fi";
  if (std::strcmp(key, "connected") == 0) return "Подключено";
  if (std::strcmp(key, "connecting_to_ethernet") == 0) return "Подключение к Ethernet";
  if (std::strcmp(key, "connecting_to_wifi") == 0) return "Подключение к Wi‑Fi";
  ...
  if (std::strcmp(key, "update_firmware") == 0) return "Установить обновление прошивки";
  if (std::strcmp(key, "no_saved_wifi_connection_reinstall_by_usb_to_reconfigure") == 0) return "Нет сохранённого подключения Wi‑Fi. Переустановите через USB для повторной настройки";
  if (std::strcmp(key, "open_192_168_4_1") == 0) return "Откройте 192.168.4.1";
  if (std::strcmp(key, "open_your_browser_and_configure_your_display") == 0) return "Откройте браузер и настройте дисплей";
  if (std::strcmp(key, "preparing_the_screen_do_not_power_off") == 0) return "Подготовка экрана. Не выключайте питание";
  if (std::strcmp(key, "restarting_display") == 0) return "Перезагрузка дисплея";
  if (std::strcmp(key, "see_the_install_guide_for_help") == 0) return "См. руководство по установке для помощи";
  ...
  if (std::strcmp(key, "the_screen_may_turn_off_do_not_power_off") == 0) return "Экран может выключиться. Не выключайте питание";
  if (std::strcmp(key, "try_installing_the_update_again") == 0) return "Попробуйте установить обновление ещё раз";
  if (std::strcmp(key, "trying_to_reconnect_to_your_saved_network") == 0) return "Попытка переподключения к сохранённой сети";
  ...
  if (std::strcmp(key, "wifi_disconnected") == 0) return "Wi‑Fi отключён";
  if (std::strcmp(key, "wifi_setup") == 0) return "Настройка Wi‑Fi";
  return espcontrol_i18n_key_en(key);
}
